...
You are acting as the **Executor**. Read the file `C:\repos\helper_files\relay\relay-to-executor.md` in full — this is the task the architect Claude left for you.
